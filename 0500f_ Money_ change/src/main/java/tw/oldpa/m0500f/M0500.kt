...
class M0500 : AppCompatActivity() {
    ...
    private fun setupViewcomponent() {
        e001 = findViewById<View>(R.id.m0500_e001) as EditText // 輸入的欄位變數名稱
        b001 = findViewById<View>(R.id.m0500_b001) as Button //執行按鈕變數名稱
        t003 = findViewById<View>(R.id.m0500_t003) as TextView //欄位變數名稱
        // --宣告傾聽--
        b001!!.setOnClickListener(b001ON)
    }
    private val b001ON = View.OnClickListener {
        val pondsFormat = DecimalFormat(".#####")
        val outcome = pondsFormat.format(e001?.text.toString().toFloat() * 31.22)
        t003!!.text = outcome
    }
}
